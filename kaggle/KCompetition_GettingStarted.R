...
# We can't compute the accuracy or AUC on the test set ourselves, since we don't
# have the dependent variable on the test set (you can compute it on the training set though!). 
